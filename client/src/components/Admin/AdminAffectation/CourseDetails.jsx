...
function CourseDetails() {
  ...
  const getData = async () => {
    const res = await axios.get(`${process.env.REACT_API_URL}/Affectation/`)
    if (res.data) {
  ...
  const handleDelete = async (id_affectation) => {
    ...
    if (confirmed) {
      const deleteAffectation = await deleteHttp(`${process.env.REACT_API_URL}/affectation/${id_affectation}`)
