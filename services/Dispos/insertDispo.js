...
const insertDispos = async () => {
    ...
    const enscrendata = [
        ...
        ["t0011", new Date(2023, 9, 10), "s0001"],
        ["t0011", new Date(2023, 9, 10), "s0002"],
        ["t0011", new Date(2023, 9, 10), "s0003"],
        ["t0011", new Date(2023, 9, 10), "s0004"],

        ["t0011", new Date(2023, 9, 13), "s0001"],
        ["t0011", new Date(2023, 9, 13), "s0002"],
        ["t0011", new Date(2023, 9, 13), "s0003"],
        ["t0011", new Date(2023, 9, 13), "s0004"],
    ]
